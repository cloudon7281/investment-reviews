...
Ukraine is increasingly becoming an integrated **R&D, combat-validation and operational-data layer of the Western defence-industrial base**. The strongest investable expressions may therefore combine Ukrainian battlefield-derived technology, software and operational data with Western capital, specialised components, certification, systems integration, production capacity and procurement access.

The investable opportunity is not necessarily the original Ukrainian developer or a single drone manufacturer. Value may accrue to companies able to absorb, localise, scale and integrate Ukraine-derived technology into Western procurement systems.
...
| Hensoldt | HAG.DE | Yes | Enabler | Radar, sensors, electronic warfare and counter-UAS detection | Growth | Direct exposure to detect/classify layers and increasingly relevant to persistent infrastructure protection. |
...
| Thales | HO.PA | No | Enabler | Radar, communications, cybersecurity, EW and command systems | Established | High-quality comparator for sensing, communications, counter-UAS and integration. |
...
- Battlefield innovation is highly modular and diffuses rapidly; airframes and other hardware may commoditise quickly.
- Procurement may deliberately remain multi-vendor, limiting monopoly rents.
...
- High-speed interconnect, networking, optical and electrical connectivity suppliers.
- On-site generation where grid connection is the binding constraint and economics are credible.
- Capital-light or equipment-selling businesses rather than heavily financed owners of fast-depreciating compute.
- Small, bounded positions in genuinely asymmetric rack-power architecture bets.
...
| Eaton | ETN | No | Diversified beneficiary | Electrical distribution, switchgear, power quality and grid connection | Established growth | High-quality comparator for electrical bottlenecks across data centres and wider electrification. |
...
Rising electricity demand, energy-security concerns and the need for reliable low-carbon power support a multi-year nuclear thesis. The thesis is increasingly supported by three overlapping drivers:

1. **Civilian reliable low-carbon power demand.**
2. **AI/data-centre electricity growth and grid scarcity.**
3. **Military and strategic resilience**, including resilient power for critical infrastructure and defence installations.

The best expressions are not indiscriminate reactor developers. The preferred hierarchy remains:
...
| Company | Ticker | Held | Expression type | Primary exposure | Risk profile | Reason for inclusion |
|---|---|---:|---|---|---|---|
| Centrus Energy | LEU | Yes | Direct | U.S. uranium enrichment and HALEU fuel supply | High-beta growth | Preferred listed exposure to Western enrichment and advanced-reactor fuel bottlenecks, increasingly supported by funded commitments. |
| BWX Technologies | BWXT | Yes | Enabler | Nuclear components, naval reactors, microreactors and engineering | Established growth | High-quality engineering and manufacturing expression with defence-supported economics and advanced-reactor optionality. |
...
- **Scaled EV and battery manufacturers**, where cost, production scale, vertical integration and global distribution matter most.
...
| Company | Ticker | Held | Expression type | Primary exposure | Risk profile | Reason for inclusion |
|---|---|---:|---|---|---|---|
| BYD ADR | BYDDY | Yes | Direct | Scaled EV manufacturing, batteries and vertical integration | Established growth | Preferred scaled EV expression; increasingly a globalisation rather than purely domestic-China thesis. |
...
- Trade barriers and localisation requirements may constrain Chinese EV expansion.
...
Quantum computing may produce very large scientific and commercial winners, but the central long-term uncertainty is **not merely whether sufficiently capable hardware can be built**.

The more fundamental investment question is whether economically important real-world workloads exist for which quantum computation will retain a material advantage over the best contemporaneous classical and AI-assisted methods.

Hardware scalability, fidelity and fault tolerance matter only if sufficiently valuable applications survive increasingly sophisticated classical approximation, heuristic optimisation and AI-based modelling.

Many real-world problems possess exploitable regularities and symmetries, or require only a useful output rather than exact simulation of the full underlying physical state. AI may therefore solve economically relevant tasks without reproducing the underlying quantum computation itself.

Historical quantum-advantage demonstrations have repeatedly stimulated major improvements in classical algorithms. Quantum claims must therefore be benchmarked against the best **contemporaneous and adversarially optimised** classical and AI approach rather than against a fixed classical baseline.

IonQ is currently the preferred single listed expression because it combines strong reported trapped-ion fidelity, Oxford Ionics' electronic-control architecture, real system and platform revenue, a large balance sheet and possible intermediate value from networking and sensing. However, its acquisition strategy creates material capital-allocation and integration risk.

Exposure should remain a small, explicit optionality sleeve rather than a core allocation.

### Application-advantage test

Evidence that materially strengthens the thesis should increasingly take the form of:

> a commercially relevant customer workload where quantum delivers a demonstrated or strongly defensible improvement in cost, speed, quality or feasibility against the best available classical and AI-assisted solution after serious red-teaming.

The following are insufficient on their own:

- more physical qubits;
- better physical-qubit fidelity;
- synthetic supremacy benchmarks;
- customer purchase of quantum access;
- mathematical asymptotic advantage without practical workload economics.
...
- Explicit milestones for scalability, fidelity, organic commercial growth and useful application advantage.
...
- **Application advantage:** useful real-world workloads may not retain material quantum advantage over improving classical and AI approaches.
...
The thesis is likely to be strongest where enterprise control and switching costs are deepest:
