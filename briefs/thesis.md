...
|---|---|---|---|---|---|---|
| How best to invest in Ukrainian defence tech, especially drone and counter-drone capability | Defence | Ukrainian firms appear to be the world leaders in practical drone warfare and counter-drone adaptation, but many of the most interesting companies are private or otherwise inaccessible; value may instead accrue to listed foreign partners, integrators, or supply-chain firms | 2026-04 | Increasing reports of Ukrainian systems defending Middle Eastern assets and U.S. bases; evidence of joint ventures and co-production with European firms; unclear public-market routes for direct investment | Repeated evidence that listed partners or suppliers are capturing meaningful revenue / orders from Ukrainian-origin systems; or emergence of a credible listed vehicle / IPO route into the ecosystem | Monitor |
| Whether counter-drone should be treated as a distinct sub-thesis rather than simply part of generic defence | Defence | Counter-drone may become a major procurement category in its own right, changing which firms are the best expressions of the defence theme | 2026-04 | Battlefield and Middle East evidence suggests rising importance of layered counter-drone systems, software, sensors, and low-cost interceptors | Multiple reviews showing differentiated winners and procurement patterns in counter-drone vs broader defence | Monitor |
| Whether resilient power / energy security should be elevated from cross-cutting theme to explicit thesis | Data-centre infrastructure; Nuclear / SMR | Energy security increasingly links data-centre demand, on-site generation, grid resilience, and nuclear exposure | 2026-03 | Current macro backdrop and power-demand trends reinforce overlap across existing themes | Clear evidence that the theme is driving distinct stock selection rather than merely sharpening existing theses | Monitor |